      ...
      {isTokenOpen && (
        ...
        >
          ...
          <form onSubmit={handleSaveToken} className="flex flex-col gap-2">
            ...
            {tokenError && (
              <p
                className="text-status-error text-[11px] flex items-center gap-1"
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 overflow-hidden">
              ...
              <span
                className="text-[11px] text-text-primary truncate font-medium"
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <div
                className="w-24 h-1.5 rounded-full bg-surface-canvas border border-border-subtle overflow-hidden"

...
export function LayerFilterBar({
  ...
  return (
    <nav
      ...
      className={cn(
        "flex items-center gap-2 max-w-full overflow-x-auto overflow-y-hidden p-1.5 rounded-xl border border-[var(--border-default)] bg-[var(--surface-panel)]/95 backdrop-blur-md shadow-xl shadow-black/20 select-none",
        className,
      )}

...
export function CodeViewer({ className }: CodeViewerProps): React.JSX.Element {
  ...
  if (
    ...
    return (
      <div
        className="w-full h-full flex flex-col items-center justify-center p-6 text-center text-zinc-500 bg-[#121417] select-none"
        data-testid="code-viewer-empty"
      >
        <div data-testid="code-viewer-container" className="contents">
          <div className="w-10 h-10 rounded-lg bg-[#0B0C0E] border border-zinc-800/80 flex items-center justify-center mb-3 text-zinc-400">
  ...
  return (
    <div
      className={`w-full h-full flex flex-col bg-[#121417] ${className ?? ""}`}
    ...
    >
      <div data-testid="code-viewer-container" className="contents">
        ...
        {/* File Header Bar */}
        <div className="px-3 py-2 border-b border-zinc-800/60 bg-[#121417] flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <Button
              ...
              className="h-6 px-2 text-[11px] flex items-center gap-1 text-zinc-400 hover:text-zinc-200"
        ...
        {fileNode.parseError && (
          <div className="px-3 py-1.5 bg-amber-500/10 border-b border-amber-500/20 text-amber-300 flex items-center gap-2 text-[11px]">
        ...
        >
          <Editor
            ...
            loading={
              <div className="w-full h-full flex flex-col items-center justify-center p-6 text-center text-zinc-500 bg-[#121417]">
                <Code2 className="w-6 h-6 animate-pulse mb-2 text-zinc-400" />
